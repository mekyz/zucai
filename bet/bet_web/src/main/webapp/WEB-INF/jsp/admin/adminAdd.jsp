...
<title>添加客服账号</title>
<meta name="pageId" content="adminAdd" />
...
<script>
	function formSubmit(){
		...
		submitForm("adminInfo","ajaxAddAdminInfo",true,"请稍后...",function(data){
				...
				<div class="x_content">
					...
					<form:form modelAttribute="adminInfo" method="post" class="form-horizontal form-label-left input_mask">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:input type="password" path="password" class="form-control" placeholder="请输入密码" />
							</div>
						</div>
						<div class="form-group">

...
<title>修改收款信息</title>
<meta name="pageId" content="payeeInfoEdit" />
...
<script>
	function formSubmit(){
		...
		submitForm("payeeInfo","ajaxUpdatePayeeInfo",true,"请稍后...",function(data){
				...
				<div class="x_content">
					...
					<form:form modelAttribute="payeeInfo" method="post" class="form-horizontal form-label-left input_mask">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:input type="number" path="sortIndex" class="form-control" placeholder="请输入优先级" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="div_photo no-border" style="width: 150px; height: 100%; margin: 0;">
									<div class="photo no-border">
										<img id="img_pic" style="border-radius: 0; width: 100%; height: 100%;" src="<%=basePath%>${payeeInfo.picUrl}" />
									</div>

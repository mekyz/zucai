...
<title>修改波胆模板信息</title>
<meta name="pageId" content="matchProfitTemplateInfoEdit" />
...
<script>
	function formSubmit(){
		...
		submitForm("matchProfitTemplateInfo","ajaxUpdateMatchProfitTemplateInfo",true,"请稍后...",function(data){

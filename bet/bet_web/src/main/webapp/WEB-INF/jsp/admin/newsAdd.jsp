...
<title>添加消息</title>
<meta name="pageId" content="newsAdd" />
...
<script>
	function formSubmit(){
		...
		submitForm("newsInfo","ajaxAddNewsInfo",true,"请稍后...",function(data){
				...
				<div class="x_content">
					...
					<form:form modelAttribute="newsInfo" method="post" class="form-horizontal form-label-left input_mask">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:textarea path="content" style="height: 800px;" placeholder="请输入内容"></form:textarea>
							</div>
						</div>
						<div class="form-group">

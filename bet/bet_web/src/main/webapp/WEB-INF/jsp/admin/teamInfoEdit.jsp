...
<title>修改球队信息</title>
<meta name="pageId" content="teamInfoEdit" />
...
<script>
	function formSubmit(){
		if(!checkNull("name","球队名称不能为空！")) return false;
		if(!checkNull("picUrl","请上传LOGO！")) return false;
		submitForm("teamInfo","ajaxUpdateTeamInfo",true,"请稍后...",function(data){
			showSuccessMsg("提示","更新成功！",function(){
				goUrl("manageTeamInfos");
			});
		},function(msg){
			showMsg(msg);
		});
...
<body>
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<br />
					<form:form modelAttribute="teamInfo" method="post" class="form-horizontal form-label-left input_mask">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:input path="name" class="form-control" placeholder="请输入球队名称" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<div class="div_photo no-border" style="width: 150px; height: 100%; margin: 0;">
									<div class="photo no-border">
										<img id="img_pic" style="border-radius: 0; width: 100%; height: 100%;" src="<%=basePath%>${teamInfo.picUrl}" />
									</div>
	...
	<script>
		...
		function uploadPicForm(){
			...
			$.ajax({url:"ajaxUploadBase64Pic?sortId=team_head",type:'POST',data:formData,dataType:'json',async:true,cache:false,contentType:false,processData:false,success:function(result){
				layer.close(loadi);

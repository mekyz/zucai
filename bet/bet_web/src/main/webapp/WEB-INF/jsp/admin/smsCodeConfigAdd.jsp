...
<title>添加验证码配置</title>
<meta name="pageId" content="smsCodeConfigAdd" />
...
<script>
	function formSubmit(){
		...
		submitForm("smsCodeConfigInfo","ajaxAddSmsCodeConfigInfo",true,"请稍后...",function(data){
				...
				<div class="x_content">
					...
					<form:form modelAttribute="smsCodeConfigInfo" method="post" class="form-horizontal form-label-left input_mask">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:input type="number" path="sortIndex" value="100" class="form-control" placeholder="请输入排序序号" />
							</div>
						</div>
						<div class="form-group">
							<label for="validateSeconds" class="control-label col-md-3 col-sm-3 col-xs-12">有效时间(秒)：</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:input type="number" path="validateSeconds" value="60" class="form-control" placeholder="请输入有效时间" />
							</div>
						</div>
						<div class="form-group">

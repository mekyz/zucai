...
<title>修改赛事信息</title>
<meta name="pageId" content="matchInfoEdit" />
...
<script>
	function formSubmit(){
		...
		submitForm("matchInfo","ajaxUpdateMatchInfo",true,"请稍后...",function(data){
			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<form:form modelAttribute="matchInfo" method="post" class="form-horizontal form-label-left input_mask">
						...
						<div class="form-group">
							<label for="halfScore1" class="control-label col-md-3 col-sm-3 col-xs-12">主场半场得分：</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:input type="number" path="halfScore1" class="form-control" placeholder="请输入主场半场得分" />
							</div>
						</div>
						<div class="form-group">
							<label for="halfScore2" class="control-label col-md-3 col-sm-3 col-xs-12">客场半场得分：</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:input type="number" path="halfScore2" class="form-control" placeholder="请输入客场半场得分" />
							</div>
						</div>
						<div class="form-group">
							<label for="finalScore1" class="control-label col-md-3 col-sm-3 col-xs-12">主场全场得分：</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:input type="number" path="finalScore1" class="form-control" placeholder="请输入主场全场得分" />
							</div>
						</div>
						<div class="form-group">
							<label for="finalScore2" class="control-label col-md-3 col-sm-3 col-xs-12">客场全场得分：</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:input type="number" path="finalScore2" class="form-control" placeholder="请输入客场全场得分" />
							</div>
						</div>
						<%-- <div class="form-group">
							<label for="handicap" class="control-label col-md-3 col-sm-3 col-xs-12">全场进球数：</label>
							<div class="col-md-6 col-sm-6 col-xs-12">
								<form:input type="number" path="handicap" class="form-control" placeholder="请输入全场进球数" />
							</div>
						</div> --%>
						<div class="form-group">

...
<title>每日数据统计信息</title>
<meta name="pageId" content="manageDayStatisticsLogInfos" />
...
<script>
	...
	$(function(){
		...
		d.ajax=function(data,callback,settings){
			getDataFromServer("ajaxGetDayStatisticsLogInfoList",data,callback,settings,function(result){
	...
	function updateMatchStatisticsJob(){
		confirmDialog("确定要统计吗？这将花费比较多的时间。","ajaxUpdateDayStatisticsJob",{},function(data){

...
html {
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="panel panel-default bk-bg-white">
								<div class="panel-heading bk-bg-white">
									<h6>
										<i class="fa fa-indent red"></i>微信入款
									</h6>
										...
										<form:form modelAttribute="userRechargeInfo" method="post" class="form-horizontal ">
											...
											<div class="bank" style="overflow: hidden;">
												...
												<div class="bank-center">
													...
													<p>
														<span>认证姓名：</span>
														<form:input path="payName" value="" placeholder="请填写您的微信实名姓名" />
													</p>
													<p>
														<span>开户银行：</span>
													...
													<p>
														<span>账号信息：</span>
														<form:input path="payBankCardId" value="" placeholder="请填写微信账号信息" />
													</p>
													<p>
	...
	<script type="text/javascript">
		...
		$("#alipay").blur(function(){
			if(!check_empty('alipay','微信号')){
				return false;
			}
			if(!check_number('alipay','微信号')){
				return false;
			}
		});
		/*开户人*/

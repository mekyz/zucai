...
<script>
	if(isMobileWeb()){
		window.location.href="registuser_m";
	}
</script>
</head>
<body>
...
input:-ms-input-placeholder { /* Internet Explorer 10-11 */
				...
				<div class="panel panel-default bk-bg-white">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<!-- <div class="col-sm-3">
								<button type="button" class="btn btn-success btn-sm checkusernum" onclick="checkusernum();">验证编号</button>
							</div> -->
						</div>
						<div class="form-group">
	...
	<script type="text/javascript">
		function checkusernum(){
			...
			var data=true;
			$.ajax({url:"/index.php?s=/home/user/checkusernum",type:"post",data:{usernum:usernumval},async:false,success:function(da){
				if(da==-1){
					check_Error('usernumber',"会员编号已存在");
					data=false;
				}else if(da==-2){
					check_Error('usernumber',"会员编号不能为空");
					data=false;
				}else{
					//	check_Ok('usernumber',"会员编号可以使用");
					layer.tips("会员编号可以使用",$("#usernumber"),{tips:[1,'#9d5f26'],time:2000,guide:0});
				}
			}});
			return data;
		}

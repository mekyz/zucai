...
@media ( max-width : 414px) {
		...
		<div id="div_data" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="panel panel-default bk-widget bk-border-off">
				<div class="panel-heading bk-bg-white">
					<h6>
						<i class="fa fa-indent red"></i>常见问题
					</h6>
					...
					<div class="row box-error">
						<div class="col-lg-12 col-md-12 col-xs-12">
							<div class="text-center">
								<h1 class="hidden-xs" style="border: 3px solid red;">暂时没有常见问题！</h1>
								<br />
								<h2 class="visible-xs" style="border: 3px solid red;">暂时没有常见问题！</h2>
	...
	<script>
		...
		function fnDataDoChoice(type){
			...
			g_type=type;
			if(!app1.isLoading){
				getDataList("ajaxGetNewsList?sortId=2",app1.newsData,parseObjData);
			}
		}
		$(function(){

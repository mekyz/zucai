								...
								<form:form modelAttribute="withdrawInfo" method="post" class="form-horizontal">
									...
									<div class="pay_list">
										...
										<p class="withdrawals-txt1">
											<span>会员编号：<em>${userInfo.userId}[${userInfo.name}]</em></span><br> <span>彩金钱包：<em>${userInfo.point/100}</em></span>
										</p>
										<div class="withdrawals-from">
											<p>
												<span>提现金额：</span> <b>￥</b>
												<form:input type="text" path="money" value="" />
												&nbsp;&nbsp;<em style="color: #d34842;">*</em>
											</p>
											<p>
												<span>图形验证码：</span> <input type="text" id="code1" value="" /> &nbsp;&nbsp;<img id="verify" src="getAuthCode">
											</p>
											<p>
												<span>短信验证：</span> <input type="text" name="code" id="code" value="" placeholder="请填写短息验证码" />&nbsp;&nbsp;
											...
											<p style="display: none">
												<span>手机号：</span> <input type="text" name="mobile" id="mobile" value="${userInfo.number}" readonly /> &nbsp;&nbsp;<em style="color: #d34842;">*</em>
											</p>
											<p>
												<span>银行卡号：</span>
												<form:input path="bankCardId" value="${userInfo.bankCardId}" />
												&nbsp;&nbsp;<em style="color: #d34842;">*</em>
											</p>
											<p>
												<span>开户银行：</span>
											...
											<p>
												<span>收款人：</span>
												<form:input path="payeeName" value="${userInfo.name}" />
												&nbsp;&nbsp;<em style="color: #d34842;">*</em>
											</p>
											<p>
												<span>申请留言：</span>

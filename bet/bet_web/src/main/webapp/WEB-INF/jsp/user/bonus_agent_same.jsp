...
<script>
	if(isMobileWeb()){
		window.location.href="bonus_agent_same_m";
	}
</script>
</head>
<body>
...
@media ( max-width : 414px) {
		...
		<div id="div_data" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="panel panel-default bk-bg-white">
				<div class="panel-heading bk-bg-white">
					<h6>
						<i class="fa fa-indent red"></i>代理平级奖金明细列表
					</h6>
	...
	<script>
		...
		function fnDataDoChoice(type){
			...
			g_type=type;
			if(!app1.isLoading){
				getDataList("ajaxGetTeamProfitInfoList?phaseId=${phaseId}&betUserId="+betUserId+"&profitType=3&startDateLong="+startDateLong+"&endDateLong="+endDateLong

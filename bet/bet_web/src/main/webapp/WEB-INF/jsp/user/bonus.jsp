...
@media ( max-width : 414px) {
		...
		<div id="div_data" class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="panel panel-default bk-bg-white">
				<div class="panel-heading bk-bg-white">
					<h6>
						<i class="fa fa-indent red"></i>明细列表
					</h6>
							...
							<div class="panel panel-default bk-bg-white">
								<div class="panel-body ">
									<form class="form-inline">
										...
										<div class="form-group">
											<div class="col-md-4">
												<select id="changetype" class='form-control col-sm-3'>
													<option value="" selected>全部</option>
													<c:forEach items="${teamProfitTypeMap}" var="item">
	...
	<script>
		...
		function fnDataDoChoice(type){
			...
			g_type=type;
			if(!app1.isLoading){
				getDataList("ajaxGetTeamProfitInfoList?phaseId=${phaseId}&betUserId="+betUserId+"&profitType="+changetype+"&startDateLong="+startDateLong+"&endDateLong="+endDateLong

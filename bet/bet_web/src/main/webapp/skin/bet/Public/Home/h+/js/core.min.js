...
function loadPage(e){
	var t=$('.main');
	$.ajax({type:'GET',url:e,dataType:'html',cache:!0,beforeSend:function(){
		t.css('opacity',0.5)
	},success:function(e){
		Pace.restart();
...
function browser(){
	function i(e){
		return eindocument.documentElement.style
	}
...
function widthFunctions(e){
	...
	var t=$('.navbar, .page-header').outerHeight(),n=$('footer').outerHeight(),r=$(window).height(),i=$(window).width();
	$('.sidebar-menu').css('height',r-105);
...
$(document).ready(function(e){
	...
	e('.nav-sidebar a').click(function(t){
		...
		if(e(this).parent().find('ul').size()!=0){
			if(e(this).parent().hasClass('opened')){
				e(this).parent().removeClass('opened');
				e(this).parent().find('ul').slideUp('slow');
			}else{
				e('.nav-parent').removeClass('opened');
				e('.nav-parent ul').slideUp('slow');
				e(this).parent().addClass('opened');
				e(this).parent().find('ul').slideDown('slow');
			}

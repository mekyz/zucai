...
// Generated 2018-5-2 23:27:44 by Hibernate Tools 4.3.5.Final
...
/**
 * TeamLeaderProfitInfo generated by hbm2java
 */
@Entity
@Table(name = "team_leader_profit_info", uniqueConstraints = @UniqueConstraint(columnNames = "profit_id"))
@Cache(usage = CacheConcurrencyStrategy.TRANSACTIONAL)
public class TeamLeaderProfitInfo implements java.io.Serializable
{
	private static final long serialVersionUID = -299361185541589803L;
	private Integer id;
	...
	public TeamLeaderProfitInfo()
	{
	}

	public TeamLeaderProfitInfo(String profitId, String phaseId, String userId, long userBetMoney, long teamBetMoney, String profitType, long profitMoney, long profitUserMoney, long fee,
	...
	@Column(name = "profit_type", nullable = false, length = 16)

 ...
 * @author libit
 */
public final class AdminCryptoTools extends com.lrcall.common.utils.crypto.AdminCryptoTools
{
	/**
	...
	{
		String result = CryptoTools.sha1(userId + CryptoTools.md5(pwd).substring(0, 7) + userId).substring(0, 32).toUpperCase();
		return result;
	}

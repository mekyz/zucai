...
import com.lrcall.common.models.ReturnListInfo;
...
public class GsonTools
{
	...
	public static <T> T getReturnObject(ReturnInfo returnInfo, Class<T> classOfT)
	{
		...
		try
		{
			...
			{
				T t = getBuildGson().fromJson(returnInfo.getMsg(), classOfT);
				return t;
			}
		}
		catch (Exception e)
	...
	public static <T> T getReturnListObjects(ReturnListInfo returnListInfo, Type classOfT)
	{
		...
		try
		{
			...
			{
				T t = getBuildGson().fromJson(returnListInfo.getMsg(), classOfT);
				return t;
			}
		}
		catch (Exception e)
